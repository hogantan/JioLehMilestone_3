...
//This test goes through sign in --> postlogin --> home fragment --> profile fragment --> settings --> delete account --> back press --> sign out
...
public class DeleteAccountUITest {
    ...
    public void DeleteAccountUITest() {
        ...
        onView(withId(R.id.tvDeleteAccount)).check(matches(withText("Delete Account")));

        onView(withId(R.id.tvConfirmWarning)).check(matches(withText("WARNING: Deleting your account is an irreversible action!")));

        onView(withId(R.id.tvConfirmDelete)).check(matches(withText("Please enter email address and password to delete this account.")));

        onView(withId(R.id.tiletConfirmEmail)).check(matches(withHint("Email address")));

        onView(withId(R.id.tiletConfirmPassword)).check(matches(withHint("Password")));

        onView(withId(R.id.btnConfirmCDelete)).check(matches(withText("Confirm delete")));
